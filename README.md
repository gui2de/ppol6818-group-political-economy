...
<ul>
<li>Treatment groups: 6 biweekly, ##-minute moderated discussions in ideologically mixed cohorts (e.g., far-left/center-right, center-left/far-right). Curriculum that emphasizes active listening, collaborative problem-solving, and non-combative disagreement on contentious issues (such as immigration or healthcare) will be followed by groups of participants</li>
<li>Control groups: No discussions, but equivalent survey completion incentives.</li>
</ul>
<p>Trained moderators will use techniques from dialogue facilitation research (e.g., setting mutual respect norms, reframing adversarial language) to prevent unproductive conflict. Post-intervention, an endline survey will re-assess polarization metrics, while follow-ups at 3/6 months will test effect durability.  </p>
<p><strong>Key Methodological Innovations</strong></p>
<ol>
<li>Ideological distance variation: The design distinguishes how the effectiveness of polarization reduction is dependent on initial ideological divergence by comparing results across discussion groups with varying partisan gaps (e.g., far-left vs. center vs. far-right pairings).</li>
<li>Mixed-methods integration: Discussion transcripts will be qualitatively analyzed to determine the mechanisms (such as stereotype reduction and empathy-building) causing quantitative attitude changes.</li>
</ol>
<h1></h1>
